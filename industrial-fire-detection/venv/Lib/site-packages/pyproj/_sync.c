...
#define __pyx_kp_u_pyproj__sync_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_get_proj_endpoint __pyx_string_tab[13]
#define __pyx_n_u_items __pyx_string_tab[14]
#define __pyx_n_u_pyproj__sync __pyx_string_tab[15]
#define __pyx_n_u_return __pyx_string_tab[16]
#define __pyx_n_u_setdefault __pyx_string_tab[17]
#define __pyx_n_u_str __pyx_string_tab[18]
#define __pyx_n_u_values __pyx_string_tab[19]
#define __pyx_kp_b_PJ_CONTEXT_void_pyproj_context_c __pyx_string_tab[20]
#define __pyx_kp_b_iso88591_1_a __pyx_string_tab[21]
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{16},{20},{12},{8},{8},{10},{8},{12},{8},{13},{18},{18},{17},{5},{12},{6},{10},{3},{6}};
    const struct { const unsigned int length: 6; } bytes_length_index[] = {{40},{20}};
    /* compression: none (271 bytes) */
static const char bytes[] = "?pyproj/_sync.pyx__Pyx_PyDict_NextRef__annotate____func____main____module____name____qualname____test___is_coroutineasyncio.coroutinescline_in_tracebackget_proj_endpointitemspyproj._syncreturnsetdefaultstrvaluesPJ_CONTEXT *(void)\000pyproj_context_create\320\000\033\2301\360\016\000\005\014\320\013(\250\001\320)>\270a";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_pyproj__sync_pyx, __pyx_mstate->__pyx_n_u_get_proj_endpoint, __pyx_mstate->__pyx_kp_b_iso88591_1_a, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
