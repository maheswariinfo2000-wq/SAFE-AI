...
#define __pyx_kp_u_pyproj__network_pyx __pyx_string_tab[2]
#define __pyx_n_u_OFF __pyx_string_tab[3]
#define __pyx_n_u_PROJ_NETWORK __pyx_string_tab[4]
...
#define __pyx_n_u_set_context_network_enabled __pyx_string_tab[14]
...
#define __pyx_n_u_is_network_enabled __pyx_string_tab[20]
#define __pyx_n_u_items __pyx_string_tab[21]
#define __pyx_n_u_ndim __pyx_string_tab[22]
#define __pyx_n_u_os __pyx_string_tab[23]
#define __pyx_n_u_pop __pyx_string_tab[24]
#define __pyx_n_u_pyproj__context __pyx_string_tab[25]
#define __pyx_n_u_pyproj__network __pyx_string_tab[26]
#define __pyx_n_u_pyproj_utils __pyx_string_tab[27]
#define __pyx_n_u_set_network_enabled __pyx_string_tab[28]
#define __pyx_n_u_setdefault __pyx_string_tab[29]
#define __pyx_n_u_strtobool __pyx_string_tab[30]
#define __pyx_n_u_values __pyx_string_tab[31]
#define __pyx_kp_b_PJ_CONTEXT_void_pyproj_context_c __pyx_string_tab[32]
#define __pyx_kp_b_PyObject_PyObject_int___pyx_skip __pyx_string_tab[33]
#define __pyx_kp_b_iso88591_Cq __pyx_string_tab[34]
#define __pyx_kp_b_iso88591_wc_2XT_Qa __pyx_string_tab[35]
...
static int __Pyx_modinit_Function_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  }
  {
    ...
    __Pyx_GOTREF(__pyx_t_1);
    const char * __pyx_import_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_PJ_CONTEXT_void_pyproj_context_c);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_import_signature)) __PYX_ERR(0, 1, __pyx_L1_error)
    #endif
    const char * __pyx_import_name = __pyx_import_signature + 19;
    void (**const __pyx_import_pointers[])(void) = {(void (**)(void))&__pyx_f_6pyproj_8_context_pyproj_context_create, (void (**)(void)) NULL};
    void (**const *__pyx_import_pointer)(void) = __pyx_import_pointers;
    const char *__pyx_import_current_signature = __pyx_import_signature;
    while (*__pyx_import_pointer) {
      if (__Pyx_ImportFunction_3_3_0(__pyx_t_1, __pyx_import_name, *__pyx_import_pointer, __pyx_import_current_signature) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_pyproj_utils, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_set_context_network_enabled};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_pyproj__context, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
  {
    ...
    __pyx_mstate_global->__pyx_tuple[0] = __Pyx_PyTuple_FromArray(__pyx_temp, 2); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 33, __pyx_L1_error)
...
*/
  {
    ...
    __pyx_mstate_global->__pyx_tuple[1] = __Pyx_PyTuple_FromArray(__pyx_temp, 1); if (unlikely(!__pyx_mstate_global->__pyx_tuple[1])) __PYX_ERR(0, 12, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{1},{19},{3},{12},{20},{12},{8},{8},{10},{8},{12},{8},{13},{28},{6},{18},{18},{7},{3},{18},{5},{4},{2},{3},{15},{15},{12},{19},{10},{9},{6}};
    const struct { const unsigned int length: 6; } bytes_length_index[] = {{40},{58},{21},{49}};
    /* compression: none (501 bytes) */
static const char bytes[] = ".?pyproj/_network.pyxOFFPROJ_NETWORK__Pyx_PyDict_NextRef__annotate____func____main____module____name____qualname____test___is_coroutine_set_context_network_enabledactiveasyncio.coroutinescline_in_tracebackenvirongetis_network_enableditemsndimospoppyproj._contextpyproj._networkpyproj.utilsset_network_enabledsetdefaultstrtoboolvaluesPJ_CONTEXT *(void)\000pyproj_context_createPyObject *(PyObject *, int __pyx_skip_dispatch)\000cstrencode\200\001\360\026\000\005\014\320\013*\250!\320+@\300\004\300C\300q\320\000\030\230\001\360\"\000\005\010\200w\210c\220\021\360\010\000\t\022\220\031\230!\2302\230X\240T\250\021\320*:\270!\330\004 \240\001\240\024\240Q\240a";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_pyproj__network_pyx, __pyx_mstate->__pyx_n_u_set_network_enabled, __pyx_mstate->__pyx_kp_b_iso88591_wc_2XT_Qa, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {0, 0, 0, 0, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 37};
    PyObject* const varnames[] = {0};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_pyproj__network_pyx, __pyx_mstate->__pyx_n_u_is_network_enabled, __pyx_mstate->__pyx_kp_b_iso88591_Cq, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
